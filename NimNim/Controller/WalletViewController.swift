        ...
        func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
               ...
               return cell
                ...
                { let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "WalletTransactionCollectionViewCell", for: indexPath) as! WalletTransactionCollectionViewCell
                    if let amount  =  walletModel?.data?[indexPath.item].amount {
                      cell.amount.text =  "$\(amount)"
                    }
                   var dateRecieved = walletModel?.data?[indexPath.item].created_at
                    ...
                    cell.orderNumber.text = walletModel?.data?[indexPath.item].descriptiona
                    cell.transactionType.text = walletModel?.data?[indexPath.item].type
